...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
                    <header class="flex justify-around items-center gap-2 py-2">
                        <div></div>
                        @if (Route::has('login'))
                            <nav class="mx-3 flex flex-1 justify-end">
                                @auth
                                    <a
                                        href="{{ url('/dashboard') }}"
                                        class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#205bff] "
                                    >
                                        Dashboard
                                    </a>
                                @else
                    ...
                    <div class="container mx-auto">
                        <h1 class="text-4xl font-bold">Bienvenue sur DevConnect</h1>
                        <p class="text-lg mt-4">Le réseau social dédié aux développeurs pour partager, collaborer et innover ensemble.</p>
                        <a href="#" class="mt-6 inline-block bg-white text-blue-600 font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-gray-100">Rejoignez-nous</a>
                    </div>
                    </section>
                    ...
                    <div class="container mx-auto">
                        <h2 class="text-3xl font-semibold">À propos de DevConnect</h2>
                        <p class="mt-4 text-gray-600">Créez un réseau social pour développeurs afin de partager des connaissances techniques, des projets et des opportunités professionnelles.</p>
                    </div>
                    </section>
                    ...
                    <div class="container mx-auto grid md:grid-cols-3 gap-8 text-center">
                        ...
                        <h4 class="text-xl font-semibold">Profil Utilisateur Enrichi</h4>
                        <p class="text-gray-600 mt-2">Ajoutez vos compétences, projets, certifications et intégrez votre portfolio GitHub/GitLab.</p>
                        </div>
                        <div class="bg-white p-6 shadow-lg rounded-lg">
                        <h4 class="text-xl font-semibold">Ajout de Connexions</h4>
                        <p class="text-gray-600 mt-2">Envoyez, acceptez et gérez vos connexions pour collaborer avec d'autres développeurs.</p>
                        </div>
                        <div class="bg-white p-6 shadow-lg rounded-lg">
                        <h4 class="text-xl font-semibold">Publications Techniques</h4>
                    ...
                    <div class="container mx-auto">
                        <h2 class="text-3xl font-semibold">Prêt à rejoindre la communauté des développeurs ?</h2>
                        <p class="mt-4">Créez votre profil et commencez à partager vos connaissances dès aujourd'hui !</p>
                        <a href="#" class="mt-6 inline-block bg-white text-blue-600 font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-gray-100">Créer un compte</a>
                    </div>
                    </section>
