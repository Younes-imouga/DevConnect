            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="content" name="content" rows="4" class="w-full border rounded-md p-2" required></textarea>
                    </div>
                    <div class="mb-4">
                        <label for="image" class=" text-gray-700 hidden" id="imageLabel">Upload Image (optional)</label>
                        <input type="file" id="image" name="image" accept="image/*" class="w-full border rounded-md p-2 hidden">
                    </div>
                    <div class="mb-4">
                        <label for="code" class=" text-gray-700 hidden" id="codeLabel">Code (optional)</label>
                        <textarea id="code" name="code" rows="4" class="w-full border rounded-md p-2 hidden" placeholder="Enter your code here"></textarea>
                    </div>
                    <div class="mb-4">
                        <label for="link" class=" text-gray-700 hidden" id="linkLabel">Link (optional)</label>
